...
* admin
* 
* O colaborador criado:
* 
* - recebe role "client";
* - pertence à mesma account;
* - NÃO recebe clientId;
* - pode criar vários Client viajantes.
* =========================================================
  */
...
req.user.accountId;
   ...
   * Auditoria.
   *
   * accountId é gravado diretamente
   * no AuditLog para permitir consultas
   * administrativas por conta.
   */
